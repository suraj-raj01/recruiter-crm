...
export default function CTA() {
    return (
        <section className="w-full">
            <div className="mx-auto py-20 max-w-full overflow-hidden bg-linear-to-tr from-orange-600/60 via-orange-500/70 to-green-600/80 shadow-sm">
                <div className="relative py-16 text-center px-3 lg:px-16">
                    {/* Background Blur */}
                    <div className="absolute -top-20 -left-20 h-72 w-72 rounded-full bg-white/10 blur-3xl" />
                    <div className="absolute -bottom-24 -right-20 h-72 w-72 rounded-full bg-green-300/20 blur-3xl" />
                    ...
                    <div className="relative z-5">
                        <span className="inline-flex items-center rounded-full border border-orange-600/80 bg-card px-4 py-2 text-sm font-bold text-orange-600 backdrop-blur">
                            <Rocket className="mr-1 h-4 w-4 text-green-600"/> Smart Recruitment
                        </span>
