...
export default function ResumeBuilderPage() {
    return (
        <section className="py-20 -mt-20">
            <div className="lg:mb-20 py-20 mx-auto max-w-6xl px-3 flex flex-col relative w-full items-center min-h-110 overflow-hidden">
                ...
                />
                <div className="mb-10 lg:text-center relative">
                    <span className="inline-flex rounded-full border bg-background border-orange-600/80 px-4 py-2 text-sm font-bold">
                       ✨ AI Resume Builder
                    </span>

                    <h1 className="mt-4 text-4xl mx-auto max-w-2xl font-extrabold tracking-tight md:text-6xl bg-linear-to-r from-orange-600 via-orange-500 to-green-600 bg-clip-text text-transparent">
                        Build Professional ATS-Friendly Resume
                    </h1>

                    <p className="mx-auto mt-4 lg:text-center max-w-4xl text-muted-foreground">
